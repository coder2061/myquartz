...
<head>
  ...
  <meta name="keywords" content="quartz, timer, schedule">
...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <!--sidebar nav start-->
            <ul class="nav nav-pills nav-stacked custom-nav">
                <li class="active"><a href="assets/index.html"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                ...
                <li class="menu-list"><a href="assets/"><i class="fa fa-tasks"></i> <span>Forms</span></a>
                    <ul class="sub-menu-list">
                        ...
                        <li><a href="assets/http://www.weidea.net"> More</a></li>
                    </ul>
                </li>
                ...
                <li class="menu-list"><a href="#"><i class="fa fa-th-list"></i> <span>Data Tables</span></a>
                    <ul class="sub-menu-list">
                        ...
                        <li><a href="assets/dynamic_table.html"> Advanced Table</a></li>
                    ...
                    <div class="panel">
                        <header class="panel-heading">
                            ...
                            <span class="tools pull-right">
                                <a href="assets/javascript:;" class="fa fa-chevron-down"></a>
                                <a href="assets/javascript:;" class="fa fa-times"></a>
                             </span>
                        </header>
                        <div class="panel-body">
                ...
                <div class="col-md-4">
                    <div class="panel">
                        <header class="panel-heading">
                            Todo List
                            <span class="tools pull-right">
                                <a class="fa fa-chevron-down" href="assets/javascript:;"></a>
                                <a class="fa fa-times" href="assets/javascript:;"></a>
                             </span>
                        </header>
                        <div class="panel-body">
...
<script src="assets/http://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.5.2/underscore-min.js"></script>
